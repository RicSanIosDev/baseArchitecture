...
protocol TitleWithTextFieldDelegate: AnyObject {
    func dateDidChange(sender: TitleWithTextField, date: Date)
}

final class TitleWithTextField: UIView {
    ...
    weak var delegate: TitleWithTextFieldDelegate?
...
private extension TitleWithTextField {
    func initView() {
